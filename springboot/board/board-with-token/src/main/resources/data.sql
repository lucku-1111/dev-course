-- application.yaml: jdbc:mysql://localhost:3306/board_token
...
-- comment table (Comment.java)
-- board_id references board.id (Comment.board 가 연관관계의 주인)
...
INSERT INTO member (user_id, password, user_name, role) VALUES
('hong', '1234', '홍길동', 'ROLE_USER'),
('kim', '1234', '김철수', 'ROLE_USER'),
('lee', '1234', '이영희', 'ROLE_USER'),
('park', '1234', '박민수', 'ROLE_USER'),
('choi', '1234', '최지현', 'ROLE_USER'),
