package com.example.spring.boardwithtoken.aop;
...
public class LogginAspect {
    ...
    // 표현식 해석 : execution(* com.example.spring.boardwithtoken.controller..*.*(..))
    ...
    @Pointcut("execution(* com.example.spring.boardwithtoken.controller..*(..))")
