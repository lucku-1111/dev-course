...
// 즉 이 클래스도 "우리 도메인(User)과 시큐리티 사이의 어뎁터"이고,
...
public class CustomOAuth2User implements OAuth2User {
    ...
    // application.yaml provider의 user-name-attribute 값이 여기까지 흘러 들어온다.
    private final String nameAttributeKey;

    // 우리 DB에 이미 가입된 회원인지. SuccessHandler가 "로그인 완료 vs 가입 완료"
