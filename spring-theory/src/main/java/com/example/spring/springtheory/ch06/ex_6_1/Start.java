package com.example.spring.springtheory.ch06.ex_6_1;

// * AOP(Aspect Oriented Programming, 관점지향 프로그래밍)
// 여러 모듈에서 '공통적으로 흩어져 있는 부가기능'(예: 트랜잭션, 로깅, 보안)
...
// 한계: 부가기능 적용 서비스가 늘 때마다 UserServiceTx 같은 프록시 클래스를 '일일히' 만들어야 하고,
// 트랙잭션이 필요 없는 메서드까지 단순 위임 코드를 다 작성해야 한다.
